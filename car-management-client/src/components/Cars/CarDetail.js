 ...
 */
const API_URL = 'https://car-frontend-h6g5.onrender.com/api';
...
const CarDetail = () => {
  ...
  return (
    <div className="car-detail-container">
      ...
      <p className="car-detail-description"><strong>Description:</strong> {car.description}</p>
      <p className="car-detail-tags"><strong>Tags:</strong> {car.tags.join(', ')}</p>
      ...
      {car.images && car.images.length > 0 ? (
        <div className="car-detail-image-container">
          {car.images.map((image, index) => (
            <img
              key={index}
              src={`https://car-frontend-h6g5.onrender.com/uploads/${image}`}
              alt={`Car ${index}`}
